...
fast_ep_shelxe_multi = os.path.join(os.environ['FAST_EP_ROOT'],
                                           'src/fast_ep_shelxe_multi.py')
...
#    job_id = run_job_cluster('python', [fast_ep_shelxe_multi, wd, nsite],
#                             [], wd, 1, timeout = 600)
...
#    job_output = run_job('python', [fast_ep_shelxe_multi, wd, nsite],
#                             [], wd)
